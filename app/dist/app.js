...
var _quip = __webpack_require__(330);
...
_quip2.default.apps.initialize({
  initializationCallback: function initializationCallback(rootNode, params) {
    ...
    ReactDOM.render(React.createElement(_App2.default, { map: rootRecord.get('maps'), __source: {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement('div', { className: _App2.default.hello, __source: {
            fileName: _jsxFileName,
            lineNumber: 8
          },
          __self: this
...
module.exports = {"container":"App__container"};

...
var _node = __webpack_require__(338);
...
var _nodeObject = __webpack_require__(342);

Object.defineProperty(exports, 'NodeObject', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_nodeObject).default;
  }
});

var _nodeTmpl = __webpack_require__(343);

Object.defineProperty(exports, 'NodeTmpl', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_nodeTmpl).default;
  }
});

var _mapTmpl = __webpack_require__(344);

Object.defineProperty(exports, 'MapTmpl', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_mapTmpl).default;
  }
});

var _nodeObjectTmpl = __webpack_require__(345);

Object.defineProperty(exports, 'NodeObjectTmpl', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_nodeObjectTmpl).default;
  }
});
...
var _jsxFileName = '/Users/kirksullivan/JavaScript/SullySoft/quipApp/my-app/src/root.jsx';

var _quip = __webpack_require__(334);
...
_quip2.default.apps.registerClass(RootRecord, 'root-record');
...
_quip2.default.apps.initialize({
  initializationCallback: function initializationCallback(rootNode, params) {
    ...
    ReactDOM.render(React.createElement(_App2.default, { record: rootRecord, __source: {
...
var _jsxFileName = "/Users/kirksullivan/JavaScript/SullySoft/quipApp/my-app/src/App.jsx";
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      if (!this.state.maps.length) return React.createElement(
        "div",
        {
          __source: {
            fileName: _jsxFileName,
      ...
      return React.createElement(_map2.default, { project: this.state, record: this.props.record, __source: {
          fileName: _jsxFileName,
          lineNumber: 18
        },
        __self: this
...
var _jsxFileName = '/Users/kirksullivan/JavaScript/SullySoft/quipApp/my-app/src/map/map.jsx';
...
var MapView = function (_Component) {
  ...
  function MapView(props) {
    ...
    _this.checkState = function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(mapState) {
        var payload, docRef;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                //     }
                payload = Object.assign({}, _this.state.project, {
                  maps: [mapState]
                ...
                _context.next = 3;
                return _this.props.record.set(payload);
  ...
  _createClass(MapView, [{
    ...
    value: function render() {
      ...
      var maps = this.state.project && this.state.project.maps;
      // if (!this.props.user.metadata) return <div>Loading...</div>;
      return _react2.default.createElement(_index.MapTmpl, {
...
var _jsxFileName = '/Users/kirksullivan/JavaScript/SullySoft/quipApp/my-app/src/map/node.jsx';
...
var _utilities = __webpack_require__(339);
...
var Node = function (_Component) {
  ...
  function Node(props) {
    ...
    console.log("line 9 on node.jsx", _react2.default.version);
  ...
  _createClass(Node, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_.NodeTmpl, {
        node: this.state.node,
        dragger: this.dragger,
        func: function func(ev) {
          (0, _utilities.makeDraggable)(ev, _this2);
        },
...
Node.getDerivedStateFromProps = function (props, state) {
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleChange = function (ev) {
    var width = 'auto';
    var children = _this3.state.node.children;
    ...
    _this3.setState({
      node: Object.assign({}, _this3.state.node, {
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _this3.setState({
                node: Object.assign({}, _this3.state.node, {
                  pointed: !_this3.state.node.pointed
                })
              });
  ...
  this.collapse = function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee2(ev) {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _this3.setState({
                node: Object.assign({}, _this3.state.node, {
                  collapsed: !_this3.state.node.collapsed
                })
              });
  ...
  this.addNode = function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee3(ev) {
      var newNode;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              newNode = {
                left: '275',
                top: '' + (_this3.state.node.children.length * 100 - 100),
                id: (0, _utilities.makeHashCode)(),
                text: 'Nodename',
                children: []
              };

              if (_this3.state.node.width) {
                newNode.parentWidth = _this3.state.node.width;
              }
              _context3.next = 5;
              return _this3.setState(Object.assign({}, _this3.state, {
                node: Object.assign({}, _this3.state.node, {
                  children: [].concat(_toConsumableArray(_this3.state.node.children), [newNode])
                })
              }));
  ...
  this.pasteNode = function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee4(ev) {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return _this3.setState(Object.assign({}, _this3.state, {
                node: Object.assign({}, _this3.state.node, {
                  children: [].concat(_toConsumableArray(_this3.state.node.children), [_this3.props.pasteOption])
                })
              }));

            case 3:
              _context4.next = 5;
              return _this3.props.clearPaste();
  ...
  this.deleteNode = function (id) {
    _this3.props.checkState({ delete: true, id: id });
  };

  this.cutNode = function (id) {
    _this3.props.checkState({ cut: true, id: id });
  };
  ...
  this.checkState = function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee5(childState) {
      var i, childrenBefore, childrenAfter, arrayCopy, cutOut;
      return _regenerator2.default.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 2:
              if (!(i < _this3.state.node.children.length)) {
                _context5.next = 24;
                break;
              }

              if (!(_this3.state.node.children[i].id === childState.id)) {
                _context5.next = 21;
                break;
              }

              childrenBefore = _this3.state.node.children.slice(0, i);
              childrenAfter = _this3.state.node.children[i + 1] ? _this3.state.node.children.slice(i + 1) : [];
              ...
              return _this3.setState({
                node: Object.assign({}, _this3.state.node, {
                  children: [].concat(_toConsumableArray(childrenBefore), _toConsumableArray(childrenAfter))
                })
              });
            ...
            case 11:
              ...
              arrayCopy = _this3.state.node.children.slice();
              cutOut = arrayCopy.splice(i, 1)[0];
              _context5.next = 16;
              return _this3.setState({
                node: Object.assign({}, _this3.state.node, {
                  children: arrayCopy
            ...
            case 16:
              _this3.props.currentCut(cutOut);
              _context5.next = 21;
              break;
            ...
            case 19:
              ...
              return _this3.setState({
                node: Object.assign({}, _this3.state.node, {
                  children: [].concat(_toConsumableArray(childrenBefore), [childState], _toConsumableArray(childrenAfter))
                })
              });
            ...
            case 24:
              _this3.props.checkState(_this3.state.node);
...
Object.defineProperty(exports, 'makeHashCode', {
  enumerable: true,
  get: function get() {
...
Object.defineProperty(exports, 'makeDraggable', {
  enumerable: true,
  get: function get() {
...
var makeDraggable = function () {
  ...
  var drag = function drag(ev) {
    ...
    draggingThis.setState({
      ...
      pos3: ev.clientX,
      pos4: ev.clientY,
      node: Object.assign({}, draggingThis.state.node, {
...
var _jsxFileName = '/Users/kirksullivan/JavaScript/SullySoft/quipApp/my-app/src/map/nodeObject.jsx';
...
var NodeObject = function (_Component) {
  _inherits(NodeObject, _Component);

  function NodeObject(props) {
    var _this2 = this;

    _classCallCheck(this, NodeObject);

    // this.textEdit = React.createRef();
    var _this = _possibleConstructorReturn(this, (NodeObject.__proto__ || Object.getPrototypeOf(NodeObject)).call(this, props));
    ...
    _this.toggleEdit = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              if (!_this.props.shouldEdit) {
                _context.next = 7;
                break;
              }
            ...
            case 3:
              if (_this.state.isEdit) {
                _this.textEdit.current.focus();
              }
              _this.props.checkState();
              _context.next = 8;
              break;

            case 7:
              _this.props.makeEditable();
    ...
    _this.deleteNode = function (ev) {
      ev.stopPropagation();
      _this.props.deleteNode(_this.props.id);
    };

    _this.cutNode = function (ev) {
      ev.stopPropagation();
      _this.props.cutNode(_this.props.id);
    };
  ...
  _createClass(NodeObject, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_.NodeObjectTmpl, (_React$createElement = {
        pasteOption: this.props.pasteOption,
      ...
      }, _defineProperty(_React$createElement, 'pasteOption', this.props.pasteOption), _defineProperty(_React$createElement, 'node', this.props.node), _defineProperty(_React$createElement, 'collapse', this.props.collapse), _defineProperty(_React$createElement, 'textEdit', this.textEdit), _defineProperty(_React$createElement, '__source', {
        fileName: _jsxFileName,
        lineNumber: 45
...
var _jsxFileName = '/Users/kirksullivan/JavaScript/SullySoft/quipApp/my-app/src/map/node.tmpl.jsx';
...
function NodeTmpl(props) {
  ...
  return _react2.default.createElement(
    'div',
    { className: 'nodeWrap', __source: {
        fileName: _jsxFileName,
        lineNumber: 7
      },
      __self: this
    },
    props.node && _react2.default.createElement(
      'div',
      {
        __source: {
          fileName: _jsxFileName,
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_.NodeObject, {
        ...
        props.node && !props.node.collapsed && props.node.children && props.node.children.map(function (node, index) {
          return _react2.default.createElement(_.Node, {
            key: index,
            checkState: props.checkState,
            deleteNode: props.deleteNode,
            node: node,
      ...
      _react2.default.createElement(
        ...
        {
          className: 'line',
          height: props.node && props.node.top && Math.abs(props.node.top) + 2 + 'px' || '2px',
        ...
        _react2.default.createElement('path', {
          d: 'm-100,0l' + (props.node.parentWidth && props.node.parentWidth - 5 || 100) + ',0c100,0,' + (props.node.left - 200) + ',' + props.node.top + ',' + (props.node.left - 89) + ',' + props.node.top + ',l' + (props.node.width && props.node.width !== 'auto' && props.node.width - 5 || 100) + ',0',
...
var _jsxFileName = '/Users/kirksullivan/JavaScript/SullySoft/quipApp/my-app/src/map/map.tmpl.jsx';
...
function MapTmpl(props) {
  ...
  if (!props.project) return _react2.default.createElement(
    'div',
    {
      __source: {
        fileName: _jsxFileName,
  ...
  return !props.maps ? _react2.default.createElement(
    'div',
    {
      __source: {
        fileName: _jsxFileName,
    ...
    _react2.default.createElement(_.Node, { checkState: props.checkState, __source: {
        fileName: _jsxFileName,
        lineNumber: 11
      },
      __self: this
    ...
    _react2.default.createElement(
      ...
      props.maps.map(function (map, index) {
        return _react2.default.createElement(_.Node, {
          clearPaste: props.clearPaste,
          key: index,
          node: map,
...
var _jsxFileName = '/Users/kirksullivan/JavaScript/SullySoft/quipApp/my-app/src/map/nodeObject.tmpl.jsx';
...
function NodeObjectTmpl(props) {
  ...
  return _react2.default.createElement(
    ...
    props.isEdit ? _react2.default.createElement('textarea', {
      type: 'text',
      name: 'text',
      value: props.text,
    ...
    _react2.default.createElement(
      'div',
      {
        className: '' + (props.isEdit ? 'functionButtons visible' : 'functionButtons'),
        __source: {
          fileName: _jsxFileName,
          lineNumber: 24
        },
      ...
      _react2.default.createElement(
        'button',
        { onClick: props.addNode, __source: {
            fileName: _jsxFileName,
            lineNumber: 29
          },
          __self: this
      ...
      _react2.default.createElement(
        'button',
        { onClick: props.cutNode, disabled: props.node.id === undefined, __source: {
            fileName: _jsxFileName,
            lineNumber: 36
          },
          __self: this
      ...
      _react2.default.createElement(
        'button',
        { onClick: props.collapse, __source: {
            fileName: _jsxFileName,
            lineNumber: 46
          },
          __self: this
    ...
    _react2.default.createElement('div', { className: 'expander', onClick: props.collapse, __source: {
        fileName: _jsxFileName,
        lineNumber: 48
      },
      __self: this
...
exports.default = NodeObjectTmpl;
